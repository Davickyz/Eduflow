...
const Signup = () => {
  ...
  const handleSignup = (e) => {
    ...
    if (finalPassword === initialPassword && course !== "" && finalPassword !== "" && firstname !== "" && lastname !== "" && email !== "") {
      ...
      if(finalPassword !== initialPassword || finalPassword === "" || initialPassword === "" || firstname === "" || lastname === "" || email === ""){
        setShowError(true)
        setTimeout(() => {
          setShowError(false)
        }, 5000)
      ...
      <section className="flex items-center justify-center gap-80 py-[80px]">
        ...
        <div className=" flex flex-col gap-8 ">
          ...
          <form action="" className="login-form">
            ...
            >
              <div>
                {finalPassword === "" || initialPassword ==="" || firstname === "" || lastname === "" || email === "" ? <img src={caution} />: finalPassword === initialPassword ? "" : <img src={caution} />}
                
              </div>
              <p className="text-xs text-yellow-accent">
                {finalPassword === "" || initialPassword ==="" || firstname === "" || lastname === "" || email === "" ? "Field cannot be blank" : finalPassword === initialPassword ? "" : "Passwords don't match"}
              </p>
            </div>
